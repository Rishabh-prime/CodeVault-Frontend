      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="flex flex-col gap-3 max-w-xs">
            <span className="text-white font-bold text-[2rem] tracking-tight leading-none">
          ...
          <div className="flex flex-wrap gap-10 sm:gap-16">
            <div className="flex flex-col gap-3">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <Link to="/snippets" className="text-zinc-300 hover:text-white text-sm transition duration-200">Snippets</Link>
              </nav>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <Link to="/settings" className="text-zinc-300 hover:text-white text-sm transition duration-200">Settings</Link>
              </nav>
            </div>
